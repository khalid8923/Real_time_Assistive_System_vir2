...
export default function Error({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-destructive/15 blur-3xl" />
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto max-w-md space-y-6 rounded-3xl border border-border bg-card p-8 text-center shadow-2xl"
      >
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            في حاجة غلط حصلت في التطبيق. جرّب تعيد تحميل الصفحة أو ترجع
            للرئيسية.
          </p>
          {error.digest && (
